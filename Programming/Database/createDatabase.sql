...
create table User_tb (id int primary key, first_name varchar(255) NOT NULL, last_name varchar(255) NOT NULL, email varchar(255) NOT NULL unique, username varchar(255) NOT NULL unique, password varchar(255) NOT NULL, birthdate date NOT NULL)
