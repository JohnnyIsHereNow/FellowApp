...
public partial class ProfileOfOthers : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
        ...
        {  user = sr.GetUserByUsername((string)(Session["id"]));
          ...
          {
              AddConnection.Text = "Cancel request!";
          }
}
    ...
    {    
         ...
         usersp = sr.GetAllPendingConnections(userme);
        bool found1 = false;
        bool found0 = false;
        bool foundp = false;
        int i = 0;
        ...
        while (!foundp && i < usersp.Length)
        {

            if (usersp[i].Username.Equals((string)Session["id"]))
            {
                foundp = true;
            }
            else
