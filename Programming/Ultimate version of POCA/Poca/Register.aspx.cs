    ...
    protected void RegisterButton_Click(object sender, EventArgs e)
    {
        ...
        WcfServiceReference.Service1Client sr = new WcfServiceReference.Service1Client();
            ...
            if (error == false)
            {
                ...
                sr.RegisterUser(txtUsername.Text, txtPassword.Text, txtEmail.Text, txtRealName.Text, passion1.SelectedIndex+1, passion2.SelectedIndex+1, passion3.SelectedIndex+1, birthdate);
