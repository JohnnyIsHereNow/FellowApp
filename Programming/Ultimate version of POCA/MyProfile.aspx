    ...
    <div class="auto-style1">
        ...
        <h1 class="auto-style1"><a href="Login.aspx" style="text-align: center">P.O.C.A</a></h1>
            ...
            <asp:Label ID="lbBirthDate" runat="server" Text="Birthdate: "></asp:Label>
                <asp:DropDownList ID="daysDb" runat="server">
                </asp:DropDownList>
                <asp:DropDownList ID="monthDb" runat="server">
                </asp:DropDownList>
                <asp:DropDownList ID="yearDb" runat="server">
                </asp:DropDownList>
            </p>
        ...
        <p class="auto-style1">
            ...
            <asp:Button ID="AddConnection" runat="server" Text="Add connection" OnClick="AddConnection_Click" Enabled="false"/>
