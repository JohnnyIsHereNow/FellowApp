...
<body>
    ...
    <div class="auto-style1">
        ...
        <p class="auto-style1">
            ...
            <select id="years" name="years"></select></p>
        <p class="auto-style1">
            &nbsp;<asp:Label ID="Label4" runat="server" Text="Month: "></asp:Label>
            <select id="months" name="months"></select></p>
        <p class="auto-style1">
            &nbsp;<asp:Label ID="Label5" runat="server" Text="Day: "></asp:Label>
&nbsp;<select id="days" name="days"></select></p>
        ...
        <p class="auto-style1">
            <asp:Label ID="Label1" runat="server" Text="Advisor: "></asp:Label>
            <asp:CheckBox ID="isAdvisorChk" runat="server" />
        </p>
        <p class="auto-style1">
            <asp:Label ID="Label2" runat="server" Text="*If advisor please select specializations in the passions fields!"></asp:Label>
        </p>
        <p class="auto-style1">
